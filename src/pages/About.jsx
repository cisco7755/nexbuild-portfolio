        ...
        <div className="max-w-[1800px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-ink-300 dark:text-ink-200 leading-relaxed">
              Quoxova is a Nigerian software development company with one focus: building products
        ...
        <div className="max-w-[1800px] mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-ink-500 dark:text-white mb-6">
                Software that solves real problems and earns its place in your stack.
              </h2>
              <p className="text-ink-300 dark:text-ink-200 leading-relaxed mb-4">
              ...
              <p className="text-ink-300 dark:text-ink-200 leading-relaxed">
              ...
              {values.map(value => (
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-ink-500 dark:text-white mb-1 text-sm">
                        {value.title}
                      </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {teamMembers.map((member, i) => (
              <motion.div
                ...
                className="p-4 md:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800"
              >
                <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {processSteps.map((step, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="p-4 md:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 relative"
              >
                <div className="text-4xl font-black text-ink-100 dark:text-ink-500 font-heading mb-4">
                  {step.number}
                </div>
                <h3 className="font-heading font-bold text-ink-500 dark:text-white mb-2">
                  {step.title}
                </h3>
                <p className="text-xs text-ink-300 dark:text-ink-200 leading-relaxed">
                  {step.description}
                </p>
              </motion.div>
            ))}
        ...
        <div className="max-w-[1800px] mx-auto px-6">
          ...
          >
            <table className="w-full text-sm">
              <thead>
                <tr>
                  <th className="text-left font-semibold text-ink-300 dark:text-ink-200 pb-4 pr-6 w-1/2">What you're evaluating</th>
                  <th className="text-center font-semibold text-indigo-600 dark:text-indigo-400 pb-4 px-6">Quoxova</th>
                  <th className="text-center font-semibold text-ink-200 dark:text-ink-300 pb-4 pl-6">Typical agency</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {[
                  ...
                  <tr key={i} className="group">
                    <td className="py-4 pr-6 text-ink-400 dark:text-ink-100 font-medium">{label}</td>
                    <td className="py-4 px-6 text-center">
                      {us ? (
                        <CheckCircle2 size={18} className="text-indigo-500 mx-auto" />
                      ) : (
                        <X size={18} className="text-ink-100 dark:text-ink-400 mx-auto" />
                      )}
                    </td>
                    <td className="py-4 pl-6 text-center">
                      {them ? (
                        <CheckCircle2 size={18} className="text-ink-100 dark:text-ink-400 mx-auto" />
                      ) : (
      ...
      <section className="section-padding border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-[1800px] mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-ink-300 dark:text-ink-200 text-lg mb-8 max-w-xl mx-auto">
